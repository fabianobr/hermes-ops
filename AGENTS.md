...
- `logs/`: captured machine inventory and prerequisite checks such as `logs/inventory.txt` and `logs/prerequisites.txt`.
- `backups/`: timestamped backup artifacts, for example `backups/docker-compose.yml.20260606-healthcheck.bak`.
